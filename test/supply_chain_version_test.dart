...
void main() {
  group('supply_chain_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/supply_chain_version.dart');

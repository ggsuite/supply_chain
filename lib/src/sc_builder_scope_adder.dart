...
class ScBuilderScopeAdder {
  /// The constructor
  ScBuilderScopeAdder({required this.builder}) {
    _check();
    _initOwner();
  }
  ...
  // ...........................................................................
  void _initOwner() {
    _owner = Owner<Scope>(willErase: (p0) => managedScopes.remove(p0));
  }
  ...
  void _applyToScope(Scope scope) {
    ...
    final bluePrints = builder.bluePrint.addScopes(hostScope: scope);
    ...
    final addedScopes = scope.addChildren(bluePrints, owner: _owner);
